                ...
                <div className="loading-img-container">
                    <Spring
                        ...
                        <svg style={{opacity: props.opacity}} id="svg-logo" data-name="LayerOne" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 477.44 479.33">
                            ...
                            <polygon class="cls-3" points="140 181 182 139 307.5 139.5 349 181 349 307 307 348 306.5 264.5 181.5 264.5 181.5 306.5 140.5 348.5 139.5 222.5 307.5 222.5 307.5 201.5 285.5 180.5 140 181" />
                        </svg>
                        )}
                    </Spring>
                </div>
